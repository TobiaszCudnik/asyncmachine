...
(function (asyncmachine) {
    ...
    */
    var Task = (function (_super) {
        ...
        Task.prototype.Cancelling_enter = function () {
            this.addState('Idle');
            this.dropState('Cancelling');
        };
        Task.prototype.Stopping_enter = function () {
            this.addState('Idle');
            this.dropState('Stopping');
        };
        Task.prototype.Running_exit = function () {
        ...
        ;
        Task.prototype.async = function (context) {
            var _this = this;
            var blocks = [];
            for (var _i = 0; _i < (arguments.length - 1); _i++) {
                blocks[_i] = arguments[_i + 1];
            }
            this.cancelAsyncTimers_();
            this.addState('Running');
            blocks.forEach(function (block) {
                _this.async_timers.push(setTimeout(block.bind(context), 1));
            });
            this.async_timers.push(setTimeout(this.dropStateLater('Running'), 1));
        }// Schedule an execution of a function in the worker.
        // TODO overload with an alternative params order
        ;
        Task.prototype.schedule = function (delay, block, context) {
            var _this = this;
            var params = [];
            for (var _i = 0; _i < (arguments.length - 3); _i++) {
                params[_i] = arguments[_i + 3];
            }
            if(this.state('Waiting')) {
                this.addState('Cancelling');
            }
            var exec_binding = this.once('Running.enter', block.apply(context, params));
            var cancel_binding = this.once('Cancelling.enter', exec_binding.clear.bind(exec_binding));
            this.schedule_timer = setTimeout(function () {
        ...
        ;
        Task.prototype.scheduleAsync = function (delay, context) {
            var _this = this;
            var blocks = [];
            for (var _i = 0; _i < (arguments.length - 2); _i++) {
                blocks[_i] = arguments[_i + 2];
            }
            this.schedule(delay, function () {
                _this.async.apply(_this, [
                    context
                ].concat(blocks));
            });
        ...
        Task.prototype.stop = function () {
            this.addState('Stopping');
        };
        Task.prototype.cancelAsyncTimers_ = function () {
            var timer;
